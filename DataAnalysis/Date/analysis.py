...
if __name__ == "__main__":
	...
	overall = overall.map(lambda x: (x[1].split('/')[1],(x[4]).replace(',','')));
	...
	bronx = bronx.map(lambda x: (x[1].split('/')[1],(x[4]).replace(',','')));
	...
	brooklyn = brooklyn.map(lambda x: (x[1].split('/')[1],(x[4]).replace(',','')));
	...
	manhattan = manhattan.map(lambda x: (x[1].split('/')[1],(x[4]).replace(',','')));
	...
	queens = queens.map(lambda x: (x[1].split('/')[1],(x[4]).replace(',','')));
	...
	staten = staten.map(lambda x: (x[1].split('/')[1],(x[4]).replace(',','')));
