...
if __name__ == "__main__":
	...
	overall = overall.map(lambda x: (datetime.strptime(x[1], "%m/%d/%Y").strftime('%b/%d/%Y').split('/')[0]));
	...
	bronx = bronx.map(lambda x: (datetime.strptime(x[1], "%m/%d/%Y").strftime('%b/%d/%Y').split('/')[0]));
	...
	brooklyn = brooklyn.map(lambda x: (datetime.strptime(x[1], "%m/%d/%Y").strftime('%b/%d/%Y').split('/')[0]));
	...
	manhattan = manhattan.map(lambda x: (datetime.strptime(x[1], "%m/%d/%Y").strftime('%b/%d/%Y').split('/')[0]));
	...
	queens = queens.map(lambda x: (datetime.strptime(x[1], "%m/%d/%Y").strftime('%b/%d/%Y').split('/')[0]));
	...
	staten = staten.map(lambda x: (datetime.strptime(x[1], "%m/%d/%Y").strftime('%b/%d/%Y').split('/')[0]));
