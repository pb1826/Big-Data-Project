...
if __name__ == "__main__":
	...
	overall = overall.map(lambda x: (datetime.strptime(x[1], "%m/%d/%Y").strftime('%b/%d/%Y').split('/')[2]));
	...
	bronx = bronx.map(lambda x: (datetime.strptime(x[1], "%m/%d/%Y").strftime('%b/%d/%Y').split('/')[2]));
	...
	brooklyn = brooklyn.map(lambda x: (datetime.strptime(x[1], "%m/%d/%Y").strftime('%b/%d/%Y').split('/')[2]));
	...
	manhattan = manhattan.map(lambda x: (datetime.strptime(x[1], "%m/%d/%Y").strftime('%b/%d/%Y').split('/')[2]));
	...
	queens = queens.map(lambda x: (datetime.strptime(x[1], "%m/%d/%Y").strftime('%b/%d/%Y').split('/')[2]));
	...
	staten = staten.map(lambda x: (datetime.strptime(x[1], "%m/%d/%Y").strftime('%b/%d/%Y').split('/')[2]));
