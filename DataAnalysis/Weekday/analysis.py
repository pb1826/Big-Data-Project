...
if __name__ == "__main__":
	...
	overall = overall.map(lambda x: (datetime.strptime(x[2], "%m/%d/%Y").weekday()));
	...
	bronx = bronx.map(lambda x: (datetime.strptime(x[3], "%m/%d/%Y").weekday()));
	...
	brooklyn = brooklyn.map(lambda x: (datetime.strptime(x[3], "%m/%d/%Y").weekday()));
	...
	manhattan = manhattan.map(lambda x: (datetime.strptime(x[3], "%m/%d/%Y").weekday()));
	...
	queens = queens.map(lambda x: (datetime.strptime(x[3], "%m/%d/%Y").weekday()));
	...
	staten = staten.map(lambda x: (datetime.strptime(x[3], "%m/%d/%Y").weekday()));
